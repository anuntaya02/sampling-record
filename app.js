...
// ===== EXPORT EXCEL (CSV fallback + pure JS xlsx) =====
window.doExport = function() {
  ...
  // Build CSV content
  const headers = ["Date","Code","Batch No.","Inspector","Picture 1","Picture 2","Picture 3","Recorded At"];
  ...
  a.href = url;
  a.download = `sampling_records_${new Date().toISOString().slice(0,10)}.csv`;
